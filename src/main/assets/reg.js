...
ele.addEventListener("focus",function(){
    ele.style.textShadow="2px 2px 6px #00ccff";
});
...
xhttp.open("POST","https://anawesomedeveloper.000webhostapp.com/MyCustomCamera/regis.php",true);
...
return ctext;
    ...
    function gotologinpage(){
        window.open("https://anawesomedeveloper.000webhostapp.com/MyCustomCamera/index.html" ,"_parent");
    }
